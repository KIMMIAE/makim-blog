...
tags:
  - book
  - UX
description: "《UX 원칙: 사용자를 행복하게 만드는 101가지 솔루션》을 읽고, 프론트엔드 개발자인 내가 바로 써먹을 수 있는 원칙만 내 입맛대로 골라 정리했다. 버튼은 버튼처럼 보이게, 링크는 링크처럼 보이게, 슬라이더는 언제 쓰는지, 빈 화면은 어떻게 채우는지. 사용성 개선 얘기가 나올 때 의견의 기준이 되어줄 내용들이다."
published: true
